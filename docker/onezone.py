...
APP_CONFIG_SOURCES_PATH = '_build/default/rel/oz_panel/etc/app.config'
VM_ARGS_SOURCES_PATH = '_build/default/rel/oz_panel/etc/vm.args'

APP_CONFIG_PACKAGES_PATH = '/etc/oz_panel/app.config'
...
def set_generate_test_web_cert(file_path, generate__test_web_cert, domain):
    flag = 'true' if generate__test_web_cert == 'true' else 'false'
